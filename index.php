  ...
  <body ng-app="myApp">
    ...
    <div class="title-container container content">
      <div class="title-wrapper">
        <h1>Never miss a payment again.</h1>
        <div class="btn-wrapper">
          <a href="create-account.php"><input class="btn-create-account" type="button" value="CREATE ACCOUNT"></a>
          <a href="login.php"><input class="btn-login" type="button" value="LOG IN"></a>
        </div>
      </div>
    </div>
